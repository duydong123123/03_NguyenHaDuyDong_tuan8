import {
  ...
  const Home = ({ navigation }) => {
    ...
    const getUserAPI = async () => {
      return await fetch("https://6541a6a8f0b8287df1fe9974.mockapi.io/user")
    ...
    return (
      <SafeAreaView style={{ flex: 1, alignItems: "center" }}>
        <Text style={{ fontSize: 30, color: "#8353E2", marginTop: "40%" }}>
          Manager Your Task
        </Text>
        <View
          style={{
        ...
        >
          ...
          <TextInput
            style={{ width: "80%", height: 20, fontSize: 20, marginLeft: 10 }}
            id="name"
          ...
          onPress={() => {
            ...
            getUserAPI().then((users) => {
              ...
              if (matchingUser) {
                ...
                alert(
                  `User with name ${enteredName} not found. Please register first.`
                );
              }
            });
          }}
